...
RSpec.describe LightrailClientRuby::Validator do
  ...
  describe ".is_valid_charge_object?" do
    ...
    it "returns false when missing required params" do
      ...
      expect(validator.is_valid_charge_object?(charge_object)).to be false
      expect(validator.is_valid_charge_object?({})).to be false
    end
  end
  ...
  describe ".is_valid_transaction_response?" do
    ...
    it "returns false when missing required params" do
      ...
      expect(validator.is_valid_transaction_response?(transaction_response)).to be false
      expect(validator.is_valid_transaction_response?({})).to be false
      expect(validator.is_valid_transaction_response?([])).to be false
    end
  end
  ...
  describe ".is_valid_fund_object?" do
    ...
    it "returns false when missing required params" do
      expect(validator.is_valid_fund_object?({amount: 1, currency: 'USD'})).to be false
      expect(validator.is_valid_fund_object?({})).to be false
      expect(validator.is_valid_fund_object?([])).to be false
    end
  end
  ...
  describe ".is_valid_card_id?" do
    ...
    it "returns false for any other type" do
      expect(validator.is_valid_card_id? ('')).to be false
      # expect(validator.is_valid_card_id? ('some random string')).to be false
      expect(validator.is_valid_card_id? (123)).to be false
      expect(validator.is_valid_card_id? ({})).to be false
      expect(validator.is_valid_card_id? ([])).to be false
    end
  end
  ...
  describe ".is_valid_code?" do
    ...
    it "returns false for any other type" do
      expect(validator.is_valid_code? ('')).to be false
      # expect(validator.is_valid_code? ('some random string')).to be false
      expect(validator.is_valid_code? (123)).to be false
      expect(validator.is_valid_code? ({})).to be false
      expect(validator.is_valid_code? ([])).to be false
    end
  end
  ...
  describe ".is_valid_transaction_id?" do
    ...
    it "returns false for any other type" do
      expect(validator.is_valid_transaction_id? ('')).to be false
      # expect(validator.is_transaction_id_valid? ('some random string')).to be false
      expect(validator.is_valid_transaction_id? (123)).to be false
      expect(validator.is_valid_transaction_id? ({})).to be false
      expect(validator.is_valid_transaction_id? ([])).to be false
    end
  end
  ...
  describe ".is_valid_amount?" do
    ...
    it "returns false for any other type" do
      expect(validator.is_valid_amount? (5.5)).to be false
      expect(validator.is_valid_amount? ('five')).to be false
      expect(validator.is_valid_amount? ({})).to be false
      expect(validator.is_valid_amount? ([])).to be false
    end
  end
  ...
  describe ".is_valid_currency?" do
    ...
    it "returns false for any other type" do
      expect(validator.is_valid_currency? ('XXXX')).to be false
      expect(validator.is_valid_currency? (123)).to be false
      expect(validator.is_valid_currency? ({})).to be false
      expect(validator.is_valid_currency? ([])).to be false
    end
  end
